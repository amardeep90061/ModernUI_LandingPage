...
const ServiceCard = ({service,index}) => {
    ...
    const handleMouseMove=(e)=>{
      ...
      setPosition({ x: e.clientX - bounds.left, y: e.clientY - bounds})
    }
  ...
  return (
    ...
    dark:shadow-white/10' onMouseEnter={()=>setVisible(true)} onMouseLeave={()=>    setVisible(false)} ref={divRef} onMouseMove={handleMouseMove}>
        ...
        w-[300px] h-[300px] absolute z-0 transition-opacity duration-500 mix-blend-lighten ${visible?'opacity-70':'opacity-0'}`} style={{top:position.y -150, left:position.x -150}}/>
            ...
            transition-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
                ...
                <div className='bg-gray-100 dark:b-gray-700 rounded-full'>
